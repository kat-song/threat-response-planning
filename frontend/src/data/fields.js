...
export const forceFields = [
    ...
    { label: "Satellite Coverage", name: "satellite_coverage", type: "number", min: 0, description: "Number of satellites providing coverage." },
    ...
    { label: "Budget Utilization (%)", name: "budget_utilization_pct", type: "number", min: 0, max: 100, step: 0.1, description: "Percentage of operations budget currently utilized." }
];

export const capabilityFields = [
    { label: "Enemy Capability", name: "Enemy_Capability_Index", type: "number", min: 0, max: 10, step: 0.1, description: "Estimated overall combat capability of the enemy." },
    { label: "Joint Force Integration", name: "JointForceIntegration", type: "number", min: 0, max: 10, step: 0.1, description: "Level of coordination between joint forces." },
    { label: "Force Readiness", name: "force_readiness_score", type: "number", min: 0, max: 100, step: 0.1, description: "Percentage readiness of the force for operations." },
    { label: "Supply Chain Resilience", name: "supply_chain_resilience", type: "number", min: 0, max: 100, step: 0.1, description: "Robustness of supply chain and logistics." },
    { label: "Prior Engagements", name: "prior_engagements", type: "number", min: 0, max: 100, step: 1, description: "Number of prior combat engagements in theater." },
    { label: "Intel Confidence", name: "intel_confidence", type: "number", min: 0, max: 100, step: 0.1, description: "Confidence level in current intelligence." },
    { label: "ROE Complexity", name: "roe_complexity", type: "number", min: 0, max: 100, step: 0.1, description: "Complexity of Rules of Engagement affecting operations." }
];
