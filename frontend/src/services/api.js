    ...
    const payload = [
        {
            ...
            ResponseTime_hrs: Number(formData.ResponseTime_hrs ?? 5),
            logistics_delay_hours: Number(formData.logistics_delay_hours ?? 2),
            CMD_COORD_SCORE: Number(formData.CMD_COORD_SCORE ?? 5),
